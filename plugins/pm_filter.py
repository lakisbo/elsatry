...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
                ...
                if clicked == typed:
                    ...
                    Joel_tgx = await query.message.reply_text(
                        ...
                        reply_markup=InlineKeyboardMarkup(
                            [
                             [
                              InlineKeyboardButton('📥 𝖣𝗈𝗐𝗇𝗅𝗈𝖺𝖽 𝖫𝗂𝗇𝗄 📥 ', url =await get_shortlink(query.message.chat.id, f"https://telegram.me/{temp.U_NAME}?start=files_{file_send.link}"))
                           ],[
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ᴏᴡɴ ɪɴғᴏ', url='https://t.me/recognizer1')
        ], [
        ...
        buttons = [[
            InlineKeyboardButton('ʀᴇᴘᴏ', url='https://t.me/recognizer1'),
        ...
        buttons = [[
           InlineKeyboardButton('ʀᴇᴘᴏ', url='https://t.me/recognizer1'),
           InlineKeyboardButton('ᴏᴡɴᴇʀ', url='https://t.me/recognizer1')
        ], [
            InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='aswin')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
